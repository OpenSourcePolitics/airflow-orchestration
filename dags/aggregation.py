...
from data_utils.metabase_aggregation.aggregation import perform_and_insert_aggregated_data, aggregate_by_date_task, aggregate_by_participation_type_task, aggregate_by_budgets_task
...
with DAG(
    ...
    aggregate_by_budgets_task = PythonOperator(
        task_id='aggregate_by_budgets_task',
        python_callable=aggregate_by_budgets_task,
        op_kwargs={},
    )
